...
const outcomes: WorkOutcome[] = [
  {
    ...
    href: "/workflows?templateId=first-run.demo.workflow",
    icon: <Rocket size={18} />,
    meta: "No credentials",
  },
  {
    ...
    href: "/tasks?agentId=bundled.software-team.repo-summary.local&version=0.1.0",
  ...
  },
  {
    ...
    href: "/tasks?agentId=bundled.software-team.code-review.local&version=0.1.0",
  ...
  },
  {
    ...
    href: "/workflows?templateId=bundled.software-team.release-readiness.workflow",
  ...
  },
  {
    ...
    href: "/tasks?agentId=bundled.software-team.test-failure-explain.local&version=0.1.0",
  ...
  },
  {
    ...
    href: "/workflows?templateId=bundled.github.pr-review-brief.workflow",
