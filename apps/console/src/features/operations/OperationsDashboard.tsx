...
import { CostAgentBreakdown } from "./components/CostAgentBreakdown";
import { CostTrendChart } from "./components/CostTrendChart";
import { MetricsGrid } from "./components/MetricsGrid";
import { RecentEventsTable } from "./components/RecentEventsTable";
import { useOperationsSummaryQuery, useRecentEventsQuery } from "./queries";
  ...
  return (
    <section className={styles.dashboard ?? ""}>
      ...
      <div className={styles.columns ?? ""}>
        <CostAgentBreakdown summary={summaryQuery.data} onExportCsv={() => void handleExportCsv()} />
