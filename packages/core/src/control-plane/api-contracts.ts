...
export const API_V1_ROUTES: ApiRouteDefinition[] = [
  ...
  { method: "GET", path: `${API_V1_PREFIX}/durable-memory/health`, operationId: "getDurableMemoryHealth" },
  { method: "POST", path: `${API_V1_PREFIX}/durable-memory/records`, operationId: "writeDurableMemoryRecord" },
  { method: "POST", path: `${API_V1_PREFIX}/durable-memory/records/get`, operationId: "getDurableMemoryRecord" },
  { method: "POST", path: `${API_V1_PREFIX}/durable-memory/records/list`, operationId: "listDurableMemoryRecords" },
  { method: "POST", path: `${API_V1_PREFIX}/durable-memory/records/search`, operationId: "searchDurableMemoryRecords" },
  { method: "POST", path: `${API_V1_PREFIX}/durable-memory/records/:id/archive`, operationId: "archiveDurableMemoryRecord" },
  { method: "POST", path: `${API_V1_PREFIX}/durable-memory/records/:id/delete`, operationId: "deleteDurableMemoryRecord" },
  { method: "POST", path: `${API_V1_PREFIX}/durable-memory/proposals`, operationId: "createDurableMemoryProposal" },
  ...
  { method: "GET", path: `${API_V1_PREFIX}/workspaces`, operationId: "listWorkspaces" },
  { method: "POST", path: `${API_V1_PREFIX}/workspaces`, operationId: "createWorkspace" },
  { method: "GET", path: `${API_V1_PREFIX}/workspaces/:id`, operationId: "getWorkspace" },
  { method: "PUT", path: `${API_V1_PREFIX}/workspaces/:id`, operationId: "updateWorkspace" },
  { method: "DELETE", path: `${API_V1_PREFIX}/workspaces/:id`, operationId: "deleteWorkspace" },
