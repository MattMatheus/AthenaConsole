...
**Reference:** `planning/backlog/active/03.05-define-content-backup-and-rollback-process.md`
...
3. Update `planning/backlog/active/README.md` for the next story ordering.
