...
1. `planning/developer/00-onboarding.md`
2. `planning/backlog/active/README.md`
3. `planning/archive/handoff.md`
4. `TODO.md`
...
Reference: `planning/backlog/active/2026.05.06-cost-governance-and-quotas.md`
...
1. Update `planning/archive/handoff.md` with a new top snapshot for the completed slice.
2. Move completed story files from `planning/backlog/active/` to `planning/backlog/completed/`.
3. Update `planning/backlog/active/README.md` to reflect the next active story ordering.
4. Refresh `planning/prompts/active/next-agent-seed-prompt.md` to point at the next story and include current context.
