...
3. Defined and documented smoke-check contract and CI usage in:
   - `planning/developer/deployment-smoke-checks.md`
4. Linked the new guide in `planning/developer/README.md`.
5. Updated checklist references to include static smoke checks:
   - `planning/developer/cycle-checklist.md`
...
- Execute Story `03.05` from `planning/backlog/active/03.05-define-content-backup-and-rollback-process.md`.
...
4. Added versioned analytics contract doc: `planning/developer/analytics-event-model.md`.
5. Linked analytics doc from `planning/developer/README.md`.
...
- Execute Story `03.04` from `planning/backlog/active/03.04-add-deployment-smoke-checks-and-broken-link-monitoring.md`.
...
- Execute Story `03.02` from `planning/backlog/active/03.02-add-website-analytics-event-model.md`.
...
- Execute Story `03.01` from `planning/backlog/active/03.01-add-seo-and-social-metadata-baseline.md`.
...
6. Added sync runbook: `planning/developer/projectathena-docs-sync.md`.
7. Added local fixture source docs under `planning/fixtures/projectathena/docs/` for repeatable local validation.
...
1. Added manifest schema: `planning/architecture/projectathena-docs-ingestion-manifest.schema.json`.
2. Added seeded ingestion manifest: `planning/architecture/projectathena-docs-ingestion-manifest.json`.
3. Added ownership map and slug-lock policy: `planning/architecture/projectathena-docs-ingestion-ownership-map.md`.
4. Updated architecture index to surface new ingestion-contract artifacts: `planning/architecture/README.md`.
...
- Execute Story `02.04` from `planning/backlog/active/02.04-implement-projectathena-docs-sync-script-and-guardrails.md`.
...
4. Added schema and downstream consumption contract docs in `planning/developer/docs-search-index-schema.md`.
5. Linked new schema reference from `planning/developer/README.md`.
...
- Execute Story `02.03` from `planning/backlog/active/02.03-establish-docs-ingestion-manifest-and-ownership-map.md`.
...
- Execute Story `02.02` from `planning/backlog/active/02.02-implement-docs-search-index-output.md`.
...
- Execute Story `01.05` from `planning/backlog/active/01.05-create-interactive-terminal-demo-for-homepage.md`.
...
- Execute Story `01.04` from `planning/backlog/active/01.04-implement-mission-control-design-system-and-layout-components.md`.
...
2. Created three new prioritized user stories in `planning/backlog/active/`:
...
3. Updated `planning/backlog/active/README.md` to prioritize the design system modernization phase.
...
- Execute Story `01.03` from `planning/backlog/active/01.03-adopt-tailwind-css-for-design-consistency.md`.
...
1. Added strategy artifact: `planning/research/active/projectathena-docs-ingestion-strategy.md`.
...
1. Added frontmatter templates and metadata/naming conventions in `planning/developer/docs-as-code-workflow.md`.
2. Expanded `planning/developer/cycle-checklist.md` with pre-publish quality checks (headings, links, summaries, route validation).
...
- Execute Story `02.01` from `planning/backlog/active/02.01-wire-projectathena-reference-docs-ingestion-strategy.md`.
...
- Canonical operational docs are defined in `planning/developer/docs-as-code-workflow.md` and `planning/developer/cycle-checklist.md`.
...
- Execute Story `01.02` from `planning/backlog/active/01.02-define-content-templates-and-qa-checklist.md`.
...
5. Added enhanced website roadmap under `planning/backlog/roadmap/roadmap.md`.
...
- Execute Story `01.01` from `planning/backlog/active/01.01-establish-docs-as-code-workflow.md`.
