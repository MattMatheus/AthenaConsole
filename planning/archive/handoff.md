...
- Updated deployment workflow/docs:
  ...
  - `planning/developer/07-github-actions-cicd.md`
...
- Completed backlog transition for Milestone 4 closure:
  - Moved `planning/backlog/bugs/BUG-2026.001-api-server-invalid-run-error-message-assertion-mismatch.md` to `planning/backlog/completed/BUG-2026.001-api-server-invalid-run-error-message-assertion-mismatch.md`.
  - Updated `planning/backlog/active/README.md` to start Milestone 5 sequence at `2026.05.01`.
  - Refreshed `planning/prompts/active/next-agent-seed-prompt.md` to seed `2026.05.01-terraform-infrastructure-foundation.md`.
