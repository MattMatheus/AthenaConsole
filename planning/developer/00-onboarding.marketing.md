...
2. `planning/archive/handoff.md`
3. `planning/archive/implementation-plan.md`
4. `TODO.md`
5. `planning/developer/docs-as-code-workflow.md`
6. `planning/developer/cycle-checklist.md`
...
- Follow section ownership and reviewer expectations in `planning/developer/docs-as-code-workflow.md`.
- Run the cycle checklist in `planning/developer/cycle-checklist.md` before handoff.

## 5. Mandatory End-Of-Cycle Handoff

Before ending a cycle, always:
1. Update `planning/archive/handoff.md` with a new top snapshot.
2. Move completed stories from `planning/backlog/active/` to `planning/backlog/completed/`.
3. Update `planning/backlog/active/README.md` with next priorities.
4. Refresh `planning/prompts/active/next-agent-seed-prompt.md` for the next cycle.
