...
- Manifest file: `planning/architecture/projectathena-docs-ingestion-manifest.json`
- Schema file: `planning/architecture/projectathena-docs-ingestion-manifest.schema.json`
...
| Website operations/editorial | `teamorchestrator.com/planning/developer` and `src/content/docs` | Website Docs | `@website-docs` | Local source of truth (not imported) |

## Initial Curated Athena Mappings

Seed entries are defined in `planning/architecture/projectathena-docs-ingestion-manifest.json` and are intentionally small to keep first sync scope reviewable.
