...
Current planning starts from the accepted reset ADRs:
...
- `planning/backlog/active/2026.17.02-implement-workflow-state-store-and-resumption-logic.md`
...
- a `2026.xx.yy` story file in `planning/backlog/active/`,
- a source epic or ADR in the current Team Orchestrator direction,
- acceptance criteria and validation expectations,
- an entry in `planning/backlog/active/README.md`,
- a matching directive in `planning/prompts/active/next-agent-seed-prompt.md`.
