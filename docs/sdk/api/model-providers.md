...
Provider configs are workspace-scoped: workspace filtering applies through membership-backed workspace scope and optional `x-athena-scope-workspaces` narrowing.
